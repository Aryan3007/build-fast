        ...
        <section className="py-12 cq-md:py-16 cq-lg:py-24" style={{ backgroundColor: bgColor }}>
            <div className="px-4 mx-auto max-w-7xl cq-sm:px-6 cq-lg:px-8">
                <div className="text-center mb-8 cq-lg:mb-16">
                    <h2 className="text-2xl cq-sm:text-3xl cq-lg:text-4xl cq-xl:text-5xl font-bold break-words text-zinc-900">
                        {title}
                    </h2>
                    <p className="mt-3 cq-sm:mt-4 cq-lg:mt-6 text-sm cq-sm:text-base cq-lg:text-xl text-gray-600 break-words max-w-3xl mx-auto">
                        {subtitle}
                    </p>
                </div>
                <div className="grid grid-cols-1 cq-md:grid-cols-3 gap-6 cq-lg:gap-8">
                    {features.map((feature, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className="bg-white p-6 cq-lg:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                            >
                                ...
                                <h3 className="text-lg cq-lg:text-xl font-bold mb-2 cq-lg:mb-3 text-gray-900 break-words">
                                    {feature.title}
                                </h3>
                                <p className="text-sm cq-lg:text-base text-gray-600 break-words leading-relaxed">
                                    {feature.description}
                                </p>
                            </div>
                        );
